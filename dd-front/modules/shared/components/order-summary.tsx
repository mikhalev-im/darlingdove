...
import { getServiceTypeTranslation, calcOrderSum } from '../utils/cart';
import { ORDER_STATUS_MAP } from '../constants';
import { PopulatedOrder } from '../interfaces/order';
...
interface OrderSummaryProps {
  ...
  onPay(comment?: string): AnyAction;
  onBack(): AnyAction;
}
    ...
    <div className={classes.wrapper}>
      ...
      <p className={classes.buttons}>
        ...
        <Button
          ...
          onClick={() => onPay(ref.current?.value)}
          color={'primary'}
          variant={'contained'}
        >
          Оплатить
