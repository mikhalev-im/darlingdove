...
import Actions, { LoadOrderPageAction, OnPayAction } from './actions';
import RootActions from '../root/actions';
import { getUserId } from '../user/selectors';
import { getOrder, payForOrder } from '../shared/utils/api';
import NotificationsActions from '../notifications/actions';

export function* loadOrderPage({ res, query }: LoadOrderPageAction) {
...
export function* onPay({ orderId }: OnPayAction) {
  try {
